...
import FemaleDoctorBreastCancer from "../assets/images/FemaleDoctorBreastCancer.png";
import ReactPlayer from "react-player";
import Button from "@mui/material/Button";
import BreastCancerLogo from "../assets/images/Breast_Cancer_Logo.png";
  ...
  return (
    <MainSection>
      ...
      <FirstSection>
        ...
        <img src={FemaleDoctorBreastCancer} alt="Female Doctor" />
      ...
      <SecondSection>
        <h1>
          Quick overview on <span>Breast Cancer</span>
        </h1>
        <div className="video-container">
          <ReactPlayer
            className="Video"
            url="https://www.youtube.com/watch?v=3DE6V_xHpVY"
            width="100%"
            height="100%"
          />
        </div>
      ...
      <DiseasesPagesInfo path="/diagnosis/breast_cancer/test" />
      {/* //================================================================================================ */}
      <SectionEight>
        <div className="footer-container">
          <img src={BreastCancerLogo} alt="diabetes-device" />
          <div className="footer-text">
            ...
            <Button
              ...
              variant="outlined"
              onClick={() => {
                navigate("/diagnosis/breast_cancer/test");
              }}
            >
              Start The Diagnosis
            </Button>
