...
import FemaleDoctorDiabetes from "../assets/images/FemaleDoctorDiabetes.png";
import ReactPlayer from "react-player";
import Button from "@mui/material/Button";
import diabetesDevice from "../assets/images/diabetes-device.png";
  ...
  return (
    <MainSection>
      <FirstSection>
        ...
        <img src={FemaleDoctorDiabetes} alt="Female Doctor" />
      ...
      <SecondSection>
        <h1>
          Quick overview on <span>Diabetes</span>
        </h1>
      ...
      <DiseasesPagesInfo path="/diagnosis/diabetes/test" />
      <SectionEight>
        <div className="footer-container">
          <img src={diabetesDevice} alt="diabetes-device" />
          <div className="footer-text">
            ...
            <Button
              ...
              variant="outlined"
              onClick={() => {
                navigate("/diagnosis/diabetes/test");
              }}
            >
              Start The Diagnosis
            </Button>
