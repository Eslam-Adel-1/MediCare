...
import inputs_heartAttack from "../Arrays/Inputs_HeartAttack";
  ...
  return (
    <MainSection>
      ...
      <div className="Container">
        <h1>
          Heart Attack <span>Diagnosis</span>
        </h1>
        {inputs_heartAttack.map((element, index) => {
          return (
            <HeartAttackInfoComponent
              name={element.name}
...
export default Heart_Attack_Test;
