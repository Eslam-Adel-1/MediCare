...
import FemaleDoctorHeartAttack from "../assets/images/FemaleDoctorHeartAttack.png";
  ...
  return (
    <MainSection>
      <FirstSection>
        ...
        <img src={FemaleDoctorHeartAttack} alt="Female Doctor" />
      ...
      <SecondSection>
        <h1>
          Quick overview on <span>Heart Attack</span>
        </h1>
        <div className="video-container">
          <ReactPlayer
            className="Video"
            url="https://www.youtube.com/watch?v=Lj7gM6eIDu0"
            width="100%"
            height="100%"
          />
        </div>
      </SecondSection>
      <DiseasesPagesInfo path="/diagnosis/heart_attack/test" />
      <SectionEight>
        <div className="footer-container">
          <img src={Heart} alt="diabetes-device" />
          <div className="footer-text">
            ...
            <Button
              ...
              variant="outlined"
              onClick={() => {
                navigate("/diagnosis/heart_attack/test");
              }}
            >
              Start The Diagnosis
            </Button>
